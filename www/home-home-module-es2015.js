...
let HomePage = class HomePage {
    constructor(modalController, payService) {
...
let PayPhoneModalComponent = class PayPhoneModalComponent {
    constructor(navParams, payService, modalController, toastController) {
        this.payService = payService;
        this.modalController = modalController;
...
PayPhoneModalComponent.ctorParameters = () => [
